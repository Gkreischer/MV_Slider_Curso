...
if(!class_exists('MV_Translations_Post_Type')) {
    class MV_Translations_Post_Type {
        ...
        public function create_post_type() {
            ...
            register_post_type('mv-translations', array(
                'labels' => esc_html__('Translations', 'mv-translations'),
        ...
        public function create_taxonomy()
        {
            register_taxonomy(
                ...
                array(
                    ...
                    'hierarchical' => false,
                    // Se o CPT vai aparecer no editor de blocos, tem que ativar
                    'show_in_rest' => true,
                    'public' => true,
        ...
        public function add_meta_boxes() {
            ...
            add_meta_box(
                ...
                esc_html__('Translation Options', 'mv-translations'),
