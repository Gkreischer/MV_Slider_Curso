...
<div class="wrap">
    ...
    <h2 class="nav-tab-wrapper">
        <a href="?page=mv-slider-admin&tab=main_options" class="nav-tab <?= $active_tab == 'main_options' ? 'nav-tab-active' : '' ?>">Main Options</a>
        <a href="?page=mv-slider-admin&tab=additional_options" class="nav-tab <?= $active_tab == 'additional_options' ? 'nav-tab-active' : '' ?>">Additional Options</a>
    </h2>
