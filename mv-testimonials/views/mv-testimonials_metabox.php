...
<table class="form-table mv-testimonials-metabox">
    ...
    <tr>
        ...
        <td>
            <!-- Sempre coincidir o id com o name do input -->
            <input type="text" name="mv_testimonials_occupation" id="mv_testimonials_occupation" class="regular-text occupation" 
    ...
    <tr>
        ...
        <td>
            <!-- Sempre coincidir o id com o name do input -->
            <input type="text" name="mv_testimonials_company" id="mv_testimonials_company" class="regular-text company" 
    ...
    <tr>
        ...
        <td>
            <!-- Sempre coincidir o id com o name do input -->
            <input type="url" name="mv_testimonials_user_url" id="mv_testimonials_user_url" class="regular-text user-url" 
