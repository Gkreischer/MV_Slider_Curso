...
if (!class_exists('MV_Testimonials')) {
    ...
    class MV_Testimonials
    {
        ...
        public function __construct()
        {
            ...
            // Substitui o archive.php por archive-mv-testimonials.php
            add_filter('archive_template', array($this, 'load_custom_archive_template'));

            // Substitui o signel.php por single-mv-testimonials.php
        ...
        public function load_custom_archive_template($template)
        {
            ...
            // Para adicionar suporte ao tema ativo do site, adicionar ao functions.php do tema: add_theme_support('mv-testimonials');
        ...
        /**
         * Substitui o single.php por single-mv-testimonials.php
         */
