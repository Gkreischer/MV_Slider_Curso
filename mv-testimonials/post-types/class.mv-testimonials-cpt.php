...
if (!class_exists('MV_Testimonials_Post_Type')) {
    class MV_Testimonials_Post_Type
    {
        ...
        /**
         * Adiciona metabox no post mv-testimonials, chamando a função add_inner_meta_boxes
         *
         * @return void
         */
        ...
        public function save_post($post_id)
        {
            ...
            // Caso o Wordpress esteja realizando um salvamento automático, não fazer nada
            if (defined('DOING_AUTOSAVE') && DOING_AUTOSAVE) {
                return;
            }

            // Verifica as permissões do usuário
            if (isset($POST['post_type']) && $POST['post_type'] == 'mv-testimonials') {
            ...
            // Realiza o save dos dados dos metaboxes
            if (isset($_POST['action']) && $_POST['action'] == 'editpost') {

                // True significa trazer o valor retornado como uma string simples
