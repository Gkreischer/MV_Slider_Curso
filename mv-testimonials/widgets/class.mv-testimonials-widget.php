...
// Precisa realizar herança do WP_Widget
class MV_Testimonials_Widget extends WP_Widget
{
    ...
    public function __construct()
    {
        ...
        // Registrar o widget para ser usado
        add_action('widgets_init', function(){
            register_widget('MV_Testimonials_Widget');
        });

        // Verifica se o widget está sendo exibido e exibe SOMENTE SE ele estiver sendo exibido
        // id_base se refere ao id passado pelo construtor a classe pai
    ...
    {
        wp_enqueue_style('mv-testimonials-style-css', MV_TESTIMONIALS_URL . 'assets/css/frontend.css', [], MV_TESTIMONIALS_VERSION, 'all');
        wp_enqueue_script('mv-testimonials', MV_TESTIMONIALS_URL . 'assets/mv-testimonials.js', ['jquery'], MV_TESTIMONIALS_VERSION, true);
    }

    /**
     * Cria o form para ser exibido na área de widgets
     *
     * @param [type] $instance: indica a instância de cada wiget utilizado na área de Widgets
     * @return void
     */
    public function form($instance)
    {
        ...
        $occupation = isset($instance['image']) ? (bool) $instance['image'] : false;
        ...
        ?>
            ...
            <p>
                ...
                <input type="number" class="tiny-text" id="<?php echo $this->get_field_id('number'); ?>" step="1" size="1" min="1" name="<?php echo $this->get_field_name('number'); ?>" value="<?php echo esc_attr($number); ?>"/>
            </p>
     ...
     *
     * @param [type] $args: parâmetros que o Widget recebe para exibição
     * @param [type] $instance
     * @return void
     */
    public function widget($args, $instance)
    {
        ...
        // Envelopando a exibição conforme os padrões do Wordpress

        echo $args['before_widget'];
        echo $args['before_title'] . $title . $args['after_title'];
        // Não usamos require_once pois o usuário pode inserir vários widgets ao mesmo tempo
        require(MV_TESTIMONIALS_PATH . 'views/mv-testimonials_widget.php');
        echo $args['after_widget'];

    }
    /**
     * Responsável por salvar os dados no BD
     *
